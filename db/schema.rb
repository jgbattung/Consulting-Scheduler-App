...
ActiveRecord::Schema[7.0].define(version: 2022_10_13_071457) do
  ...
  create_table "users", force: :cascade do |t|
    ...
    t.datetime "created_at", null: false
    t.datetime "updated_at", null: false
    t.string "consultation_link"
    t.string "specialization"
    t.string "image"
    t.index ["consultation_link"], name: "index_users_on_consultation_link", unique: true
